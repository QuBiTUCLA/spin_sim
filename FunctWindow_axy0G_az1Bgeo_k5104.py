...
# Defining Hamiltonian operators
    ...
    theta_list=linspace(0.0, pi/2, 20)
...
# Defining Zeeman Field Window
    ...
    B=logspace(log10(float(0.05)),log10(1000),50)
...
# Hyperfine Coupling Constants (in eV)
    ...
    tlist=[]
    tlist = linspace(0.0, float(6)/k, 2500) # Defining time instants for simulation
    noe=len(tlist)
    dt=tlist[1]-tlist[0]
    print("dt = ", dt)
    ...
    fl = open('data/FW_axy0G_az1Bgeo_k5104.csv', 'w')
    ...
    savefig('Figures/FW_axy0G_az1Bgeo_k5104.eps')
    savefig('Figures/FW_axy0G_az1Bgeo_k5104.jpg')
