function [results,parameters] = LauncherModelOpt2(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ctPop=1:population.Size
    [mapping,mappingCost] = GANelderMead2(population.Chromosomes{ctPop},...
...
while(genNb < maxGenerations && ...
        ...
        population.Chromosomes{1}.Costs(1) > 0.2)
    ...
    while(length(parentIdx) > 1)
        ...
        %Mutation using Nelder-Mead
        for ctPop=1:children.Size
            [mapping,mappingCost] = GANelderMead2(children.Chromosomes{ctPop},...
...
%Radius checking (NV-Carbon 1) NOT IN PERCENT
