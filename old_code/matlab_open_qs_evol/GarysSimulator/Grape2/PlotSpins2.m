classdef PlotSpins2 < handle
    ...
    methods
        ...
        function Propagate(obj, params, propagator)
            ...
            time = (params.maxTimeStep + params.minTimeStep)/2 + ...
                (params.maxTimeStep - params.minTimeStep)/2*propagator.ControlFields.Pulse(1,:);
            obj.TotalPulse = [0 cumsum(time,2)];
            ...
            for ct=1:propagator.PulseLength
